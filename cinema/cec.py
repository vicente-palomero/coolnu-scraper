...
feroz = [
    ('https://es.wikipedia.org/wiki/Anexo:Medalla_del_CEC_a_la_mejor_pel%C3%ADcula', 'cec pelicula', 1, 2, -1),
    ('https://es.wikipedia.org/wiki/Anexo:Medalla_del_CEC_al_mejor_director','cec director', -1, -1, 1),
]
